...
### 1. Baza danych (Neon PostgreSQL + Drizzle ORM)
...
### 3. Moduł przypomnień (Cloudflare Workers Cron)

- Cloudflare Worker (osobny od głównego Hono Worker) uruchamiany codziennie (np. o 08:00) via Cron Trigger w `wrangler.jsonc`
...
### 4. API (Hono na Cloudflare Workers)
...
|---------|-------|--------------|
| Stack | TanStack Start + Hono/Cloudflare Workers + Neon PostgreSQL + Drizzle ORM | Istniejący stack produkcyjny |
...
- Główny PRD Wspólniak: `docs/002-prd.md`
- Stack zweryfikowany: github.com/CrystalGamesStudio/wspolniak (README.md)
